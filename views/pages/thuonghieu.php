        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    <h2><?= $this->e($thuonghieu_name->th_ten) ?></h2>
                    <div class="breadcrumb__option">
                        <a href="trang-chu">Trang chủ</a>
                        <span><?= $this->e($thuonghieu_name->th_ten) ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h2>Sản phẩm thương hiệu <?= $this->e($thuonghieu_name->th_ten) ?> </h2>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        if ($(".col-lg-3.col-md-4.col-sm-6:hidden").length < 4) {
            $("#load").fadeOut('slow');
            $("#loadMore").remove();
        }
