...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <?php if (isset($_SESSION['msg_sua'])) : ?>
            ...
            <?php } ?>
            <form method="post" name="frm" id="frmHinhThucThanhToan" action="/admin/hinhthucthanhtoan/sua/<?=$this->e($hinhthucthanhtoan['id'])?>" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="hinhthucthanhtoan_id" class="font-weight-bold"> Tên hình thức thanh toán</label>
                    <input type="text" name="ht_ten" class="form-control"  value="<?=$this->e($hinhthucthanhtoan['ht_ten'])?>" id="ht_ten"  placeholder="Nhập tên hình thức thanh toán">
                </div>
